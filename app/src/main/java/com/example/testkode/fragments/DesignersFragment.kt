...
import com.example.testkode.adapter.DesignersAdapter
...
class DesignersFragment() : Fragment() {
    ...
    lateinit var recyclerAdapter: DesignersAdapter
    ...
    private fun initRecyclerView(userList: UserList){
        ...
        recyclerView.apply {
            ...
            recyclerAdapter = DesignersAdapter(userList)
