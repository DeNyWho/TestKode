...
import com.example.testkode.adapter.Back_OfficeAdapter
import com.example.testkode.models.UserList
import com.example.testkode.viewModel.MainViewModel

class Back_OfficeFragment() : Fragment() {
    lateinit var recyclerView: RecyclerView
    lateinit var viewModel: MainViewModel
    lateinit var recyclerAdapter: Back_OfficeAdapter
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_back__office, container, false)
    ...
    private fun initRecyclerView(data: UserList){
        ...
        recyclerView.apply {
            ...
            recyclerAdapter = Back_OfficeAdapter(data)
