...
class FrontendAdapter(private var list: UserList) : RecyclerView.Adapter<FrontendAdapter.MyViewHolder>() {

    var userList: List<User> = list.items.filter { it.department == "frontend" }
