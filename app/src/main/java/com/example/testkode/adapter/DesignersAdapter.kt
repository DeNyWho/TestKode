...
class DesignersAdapter(private var list: UserList) : RecyclerView.Adapter<DesignersAdapter.MyViewHolder>() {

    var userList: List<User> = list.items.filter { it.department == "design" }
