...
class BackendAdapter(private var list: UserList) : RecyclerView.Adapter<BackendAdapter.MyViewHolder>() {

    var userList: List<User> = list.items.filter { it.department == "backend" }
