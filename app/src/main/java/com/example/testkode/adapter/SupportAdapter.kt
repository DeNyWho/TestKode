...
class SupportAdapter(private var list: UserList) : RecyclerView.Adapter<SupportAdapter.MyViewHolder>()  {

    var userList: List<User> = list.items.filter { it.department == "support" }
