...
class Back_OfficeAdapter(private var list: UserList) : RecyclerView.Adapter<Back_OfficeAdapter.MyViewHolder>() {
    var userList: List<User> = list.items.filter { it.department == "back_office" }
