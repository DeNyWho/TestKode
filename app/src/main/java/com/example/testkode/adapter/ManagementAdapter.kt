...
class ManagementAdapter(private var list: UserList) : RecyclerView.Adapter<ManagementAdapter.MyViewHolder>() {

    var userList: List<User> = list.items.filter { it.department == "management" }
