...
class AnalyticsAdapter(private var list: UserList) : RecyclerView.Adapter<AnalyticsAdapter.MyViewHolder>() {

    var userList: List<User> = list.items.filter { it.department == "analytics" }
